...
| Item | Link / value |
|------|----------------|
| Datasheet | [../../measurements/datasheets/cinema-02.md](../../measurements/datasheets/cinema-02.md) |
...
| Version history extras | `measurements/version-history/cinema-02-*` |
...
| Campaign | Evidence |
|----------|----------|
| VC-2026-08 | UI screenshots + ui-load log [../logs/cinema-02.md](../logs/cinema-02.md) |
| VC-2026-08-LISTEN | [VC-2026-08-LISTEN](../campaigns/VC-2026-08-LISTEN/sessions/20260802-L001-cinema-02.md) |
...
Heavy chain; fatigue risk; avoid OEM stack.
