...
| Plugins (order) | `equalizer#0 → exciter#0 → stereo_tools#0 → limiter#0` |
...
| Music Fidelity | 4.0 | design-audit + ui-load |
...
- main: `../screenshots/main/music-hd-01.png`
- chain: `../screenshots/chain/music-hd-01.png`
- equalizer: `../screenshots/equalizer/music-hd-01.png`
- compressor: `../screenshots/compressor/music-hd-01.png` (if plugin present)
