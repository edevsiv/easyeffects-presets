# Validation log — `volume-booster-01`
...
| Hardware ID | HW-001 |
| Preset | `volume-booster-01` |
| Seal | **Beta** |
| Content used | Film (mpv session ambient) + UI load probes |
| Plugins (order) | `equalizer#0 → compressor#0 → limiter#0` |
...
| Treble Detail | 3.0 | design-audit + ui-load |
...
| Dynamic Control | 3.0 | design-audit + ui-load |
| Perceived Loudness | 4.5 | design-audit + ui-load |
| **Overall** | **2.85** | mean of above |
...
- main: `../screenshots/main/volume-booster-01.png`
- chain: `../screenshots/chain/volume-booster-01.png`
- equalizer: `../screenshots/equalizer/volume-booster-01.png`
- compressor: `../screenshots/compressor/volume-booster-01.png` (if plugin present)
